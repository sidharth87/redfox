 ...
 * \param pDst \ref destination_image_pointer.
 * \param nDstStep \ref destination_image_line_step.
 * \param pHuffmanTableDC DC Huffman table for JPEG decoding, format as specified in the JPEG standard.
 * \param pHuffmanTableAC AC Huffman table for JPEG decoding, format as specified in the JPEG standard.
 * \param oSizeROI \ref roi_specification.
 * \return Error codes:
 *         - ::NPP_SIZE_ERROR For negative input height/width or not a multiple of
 *           8 width/height.
...
nppiDecodeHuffmanScanHost_JPEG_8u16s_P1R(const Npp8u  * pSrc, Npp32s nLength,
                  Npp32s restartInterval, Npp32s Ss, Npp32s Se, Npp32s Ah, Npp32s Al,
                    ...
                    Npp8u  * pHuffmanTableDC, 
                    Npp8u  * pHuffmanTableAC, 
                    NppiSize oSizeROI); 
 ...
 * \param apHuffmanDCTable DC Huffman tables for JPEG decoding, format as specified in the JPEG standard.
 * \param apHuffmanACTable AC Huffman tables for JPEG decoding, format as specified in the JPEG standard.
 ...
 */
 ...
 nppiDecodeHuffmanScanHost_JPEG_8u16s_P3R(const Npp8u * pSrc, Npp32s nLength,
                  Npp32s nRestartInterval, Npp32s nSs, Npp32s nSe, Npp32s nAh, Npp32s nAl,
                    ...
                    Npp8u * apHuffmanDCTable[3], 
                    Npp8u * apHuffmanACTable[3], 
                    NppiSize aSizeROI[3]);
 ...
 * \param pDst Byte-stuffed huffman encoded JPEG scan.
 * \param nLength Byte length of the huffman encoded JPEG scan.
 * \param apHuffmanTableDC DC Huffman tables for JPEG decoding, format as specified in the JPEG standard.
 * \param apHuffmanTableAC AC Huffman tables for JPEG decoding, format as specified in the JPEG standard.
 * \param aSizeROI \ref roi_specification.
 * \return Error codes:
 *         - ::NPP_SIZE_ERROR For negative input height/width or not a multiple of
 *           8 width/height.
